...
* {\small Tried six models with different combinations of imputatin methods and feature selection methods. All models are not doing well for specificity.}

* {\small KNN_corr appears to do better among models for its highest accuracy and kappa, second highest sensitivity and specificity, reasonable brier and roc auc.}

* {\small P-values are not significant.} 
